...
uint32_t WinKeyIF::GetKey(const Key* key) {
  ...
  for (i = 0; i < 8 && key->k; i++, key++) {
    switch (key->f) {
      ...
      case pc80sft:
        if (pc80mode &&
            ((keyboard[VK_DOWN] & 0x80) || (keyboard[VK_LEFT] & 0x80)))
          return 0;
        break;
...
const WinKeyIF::Key WinKeyIF::KeyTable106[16 * 8][8] = {
    // 00
    {
        KEY(VK_NUMPAD0), KEYF(VK_INSERT, nex), TERM,
    },  // num 0
    {
        KEY(VK_NUMPAD1), KEYF(VK_END, nex), TERM,
    },  // num 1
    {
        KEY(VK_NUMPAD2), KEYF(VK_DOWN, nex), KEYF(VK_DOWN, arrowten), TERM,
    },
    {
        KEY(VK_NUMPAD3), KEYF(VK_NEXT, nex), TERM,
    },  // num 3
    {
        KEY(VK_NUMPAD4), KEYF(VK_LEFT, nex), KEYF(VK_LEFT, arrowten), TERM,
    },
    {
        KEY(VK_NUMPAD5), KEYF(VK_CLEAR, nex), TERM,
    },  // num 5
    {
        KEY(VK_NUMPAD6), KEYF(VK_RIGHT, nex), KEYF(VK_RIGHT, arrowten), TERM,
    },
    {
        KEY(VK_NUMPAD7), KEYF(VK_HOME, nex), TERM,
    },  // num 7
    ...
    {
        KEY(VK_NUMPAD9), KEYF(VK_PRIOR, nex), TERM,
    },  // num 9
    {
        KEY(VK_MULTIPLY), TERM,
    },  // num *
    {
        KEY(VK_ADD), TERM,
    },  // num +
    ...
    {
        KEY(VK_SEPARATOR), KEYF(VK_DELETE, nex), TERM,
    },  // num ,
    {
        KEY(VK_DECIMAL), TERM,
    },  // num .
...
const WinKeyIF::Key WinKeyIF::KeyTable98[16 * 8][8] = {
    ...
    {
        KEY(VK_NUMPAD2), KEYF(VK_DOWN, arrowten), TERM,
    },  // num 2
    {
        KEY(VK_NUMPAD3), TERM,
    },  // num 3
    {
        KEY(VK_NUMPAD4), KEYF(VK_LEFT, arrowten), TERM,
    },  // num 4
    {
        KEY(VK_NUMPAD5), TERM,
    },  // num 5
    {
        KEY(VK_NUMPAD6), KEYF(VK_RIGHT, arrowten), TERM,
    },  // num 6
    {
        KEY(VK_NUMPAD7), TERM,
    },  // num 7
    ...
    // 01
    {
        KEY(VK_NUMPAD8), KEYF(VK_UP, arrowten), TERM,
    },  // num 8
    {
        KEY(VK_NUMPAD9), TERM,
    },  // num 9
